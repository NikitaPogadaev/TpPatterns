...
class Red_castle(Place_Obj):
    ...
    def __init__(self, x=0, y=0, ind=True):
        super().__init__()
        self.x_pose = x
        self.y_pose = y
        self.active = ind
...
class Blue_castle(Place_Obj):
    ...
    def __init__(self, x=10, y=0, ind=True):
        super().__init__()
        self.x_pose = x
        self.y_pose = y
        self.active = ind
...
class MAP:
    ...
    def __init__(self):
        ...
        self.map[(10, 0)] = Blue_castle()
        """for i in range(22, 29):
            for j in range(22, 29):
                self.map[(i, j)] = Swamp()"""
        for i in range(40):
            self.map[(random.randint(3, 8), random.randint(3, 8))] = Gold(col=random.randint(50, 100))
        self.map[(5, 5)] = Egg()
